  ...
  "members": [
    {
      ...
      "missions": [
        { "id": "M0", "title": "홈페이지 리뉴얼 런칭",
          ...
          "progress": 0.35,             // 0~1
          "desc": "미션 설명 1~3문장",  // [ver0.13] 미션 카드에 표시되는 상세 설명(선택)
          "roadmap": [ { "step": "파워링크 소재", "done": true,
                         "detail": "이 단계의 상세 내용" },   // [ver0.13] 노드 hover 팝업에 step+detail 표시(선택)
      ...
      "gates": {
        "red":    [ { "ts": "260725_1530", "item": "M3 텀블벅 포함 여부 결정",
                      ...
                      // [ver0.14] 결재 반영 필드 — 코워크가 Poffice_confirm 처리 시 기록(대시보드는 읽기만):
                      "decision": "승인",       // 승인 | 반려 | 보류 (있으면 게이트에 배지+메모 표시)
                      "reply": "텀블벅 포함으로 확정",  // 결재 메모
                      "decided_by": "심상윤", "decided_at": "260725_1610",
                      "outcome": "반려"         // (선택) 반려 시 표시용. 승인/반려는 state=완료로 인박스 제외
                    } ],
        "yellow": [], "green": []
      },
      "todos": [
